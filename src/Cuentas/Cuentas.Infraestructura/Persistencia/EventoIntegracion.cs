...
{
    public EventoIntegracion(Guid eventoId, string tipo, string contenido, DateTime ocurridoEn) { EventoId = eventoId; Tipo = tipo; Contenido = contenido; OcurridoEn = ocurridoEn; }
